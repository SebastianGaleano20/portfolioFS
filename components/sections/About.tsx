          ...
          >
            ...
            <div className="space-y-4 text-steel-400 leading-relaxed">
              <p>
                ...
                crear productos digitales que hacen la diferencia. Combinamos
                experiencia técnica con sensibilidad de diseño para entregar
                soluciones que no solo funcionan, sino que deleitan.
              </p>
              <p>
                Trabajamos con startups, pymes y empresas establecidas que
                entienden que la tecnología bien aplicada es una ventaja
                competitiva real. Cada proyecto es una oportunidad de crear algo
                excepcional.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {TEAM.map((member, i) => (
                ...
                >
                  ...
                  <div
                    className={cn(
                      "w-14 h-14 rounded-xl bg-gradient-to-br flex items-center justify-center mb-4 shadow-glow-sm",
                      member.color,
                    )}
                  >
              ...
              <div className="col-span-2 rounded-2xl border border-cyan-400/20 bg-cyan-400/5 p-5 flex items-center gap-4">
                <div className="w-10 h-10 rounded-lg bg-cyan-400/20 flex items-center justify-center shrink-0">
                  <span className="text-cyan-400 text-xl font-heading font-bold">
                    +
                  </span>
                </div>
                <div>
                  ...
                  <div className="text-steel-400 text-xs mt-0.5">
                    Siempre buscamos talento excepcional
                  </div>
                </div>
              </div> */}
            </div>
